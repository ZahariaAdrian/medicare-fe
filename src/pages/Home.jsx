            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  atque quaerat veniam vitae reiciendis nihil assumenda. Iure
                  nulla amet corrupti?
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              ...
              <div className="mt-[30px]">
                <img
                  ...
                  alt="hero02"
                />
                <img className="w-full " src={heroImg03} alt="hero03" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="p-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            {/* feature img */}
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50] lg:mt-0">
